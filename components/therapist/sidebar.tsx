...
const NAV = [
  ...
  { href: "/dashboard/skill-building", label: "Skill Building", icon: Sparkles },
  { href: "/dashboard/reflections", label: "Reflections", icon: MessageSquareHeart },
  ...
  { href: "/dashboard/coaching-videos", label: "Coaching Videos", icon: Clapperboard },
